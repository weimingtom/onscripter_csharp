...
//		static unsigned long tmp_acc_num[4];
		...
		private static void calcWeightedSumColumnInit(UnsignedCharPtr[] src,
...
//		    }
		...
		private static void calcWeightedSumColumn(UnsignedCharPtr[] src, int y,
		                                  int interpolation_height,
		                                  int image_width, int image_height,
		                                  int image_pixel_width, int byte_per_pixel)
		{
...
//		    }
		...
		private static void calcWeightedSum(UnsignedCharPtr[] dst, int x_start, int x_end,
